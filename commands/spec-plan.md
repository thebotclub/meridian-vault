...
| #   | Rule                                                                                                     |
| --- | -------------------------------------------------------------------------------------------------------- |
| 1   | **NO sub-agents during planning** - Use direct tools only. Exception: Step 1.7 launches `plan-verifier` + `plan-challenger` via the **Task tool** (`subagent_type="sf:plan-verifier"` and `"sf:plan-challenger"`). |
...
```
Task(
  subagent_type="sf:plan-verifier",
...
```
Task(
  subagent_type="sf:plan-challenger",
  run_in_background=true,
  prompt="""
  **Plan file:** <plan-path>
  **User request:** <original task description from user>
